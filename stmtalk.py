...
def main():
    ...
    if result[7] == 1:
        ...
        STM32_COMM.TARGET_CFGS[STM32_COMM.TARGET_IROM]['blocksize'] = 0x4000
        STM32_COMM.TARGET_CFGS[STM32_COMM.TARGET_IROM]['limit']     = 0x08100000
    else:
        # STM32F103
        stm_comm.set_mcu ('stm32f103')
        STM32_COMM.TARGET_CFGS[STM32_COMM.TARGET_IROM]['blocksize'] = 0x400
        STM32_COMM.TARGET_CFGS[STM32_COMM.TARGET_IROM]['limit']     = 0x08020000
